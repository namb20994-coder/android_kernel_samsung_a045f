...
bool N26_ic_sy6970 = false;
bool N26_ic_sgm41543 = false;
int N26_temp_cycle = -1;
#endif
/*-S96616AA3 guhan01,wt.battery cycle function*/
...
/*+S96616AA3 guhan01,wt.battery cycle function*/
#if defined (CONFIG_N26_CHARGER_PRIVATE)
static ssize_t set_battery_cycle_show(
...
static ssize_t set_battery_cycle_store(
	struct device *dev, struct device_attribute *attr,
						const char *buf, size_t size)
{
	signed int temp;
...
/*+S96616AA3 guhan01,wt.battery cycle function*/
static DEVICE_ATTR_RW(set_battery_cycle);
/*-S96616AA3 guhan01,wt.battery cycle function*/
//+P240305-05569  guhan01.wt 20240318,one ui 6.1 charging protection
...
/*+S96616AA3 guhan01,wt.battery cycle function*/
#if defined (CONFIG_N26_CHARGER_PRIVATE)
			device_create_file(&info->bat_psy->dev,&dev_attr_set_battery_cycle);
#endif
/*-S96616AA3 guhan01,wt.battery cycle function*/
//+P240305-05569  guhan01.wt 20240318,one ui 6.1 charging protection
...
/*+S96616AA3 guhan01,wt.battery cycle function*/
		...
		pr_err("Check if the charge ic is sgm41543D or sy6970,charger_ic_list[i]->name=%s\n\n",charger_ic_list[i]->name);
		if(!strcmp("sy6970", charger_ic_list[i]->name))
		{
			pr_err("charge ic is sy6970\n");
			N26_ic_sy6970 = true;
		} else if(!strcmp("sgm41543D", charger_ic_list[i]->name)) {
			pr_err("charger ic is sgm41543D\n");
			N26_ic_sgm41543 = true;
		} else {
			pr_err("charger ic is not sgm41543D-and-sy6970 Cyclefv uses default configuration\n");
		}
	}
#endif
/*-S96616AA3 guhan01,wt.battery cycle function*/
